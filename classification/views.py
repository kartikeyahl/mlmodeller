...
def DecisionTree(request):
    ...
    template_name = 'decission-tree.html'
    context = {
        'result':result
    }
...
def KNearestNeighbors(request):
    ...
    classifier.fit(X_train, y_train)
    result = classifier.predict(sc.transform(lst))
    template_name = 'k-nearest-neighbours.html'
    context = {
        'result':result
    }
    return render(request,template_name,context)
...
def LogisticRegression(request):
    ...
    classifier.fit(X_train, y_train)
    result = classifier.predict(sc.transform(lst))
    template_name = 'logistic-regression.html'
    context = {
        'result':result
    }
    return render(request,template_name,context)
...
def NaiveBayes(request):
    ...
    classifier.fit(X_train, y_train)
    result = classifier.predict(sc.transform(lst))
    template_name = 'naive-bayes-regression.html'
    context = {
        'result':result
    }
    return render(request,template_name,context)
...
def RandomForest(request):
    ...
    classifier.fit(X_train, y_train)
    result = classifier.predict(sc.transform(lst))
    template_name = 'random-forest-regression.html'
    context = {
        'result':result
    }
    return render(request,template_name,context)
...
def SupportVector(request):
    ...
    classifier.fit(X_train, y_train)
    result = classifier.predict(sc.transform(lst))
    template_name = 'support-vector.html'
    context = {
        'result':result
    }
    return render(request,template_name,context)
