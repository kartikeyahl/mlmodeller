...
def DecisonTreeRegression(request):
    ...
    template_name = 'decission-tree-regression.html'
    context = {
        'result': result
    }
...
def MultipleLinearRegression(request):
    ...
    result = regressor.predict(lst)
    template_name = 'multiple-linear-regression.html'
    context = {
        'result': result
    }
    return render(request, template_name, context)
...
def PolynomialRegression(request):
    ...
    template_name = 'polynomial-regression.html'
    context = {
        'result': result
    }
    return render(request, template_name, context)
...
def SimpleLinearRegression(request):
    ...
    regressor.fit(X_train, y_train)
    result = regressor.predict(lst)
    template_name = 'simple-linear-regression.html'
    context = {
        'result': result
    }
    return render(request, template_name, context)
...
def SupportVectorRegression(request):
    ...
    template_name = 'support-vector-regression.html'
    context = {
        'result': result
    }
    return render(request, template_name, context)
